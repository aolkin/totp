<script lang="ts">
  ...
  const { visible = false, onUpdate, onDismiss }: Props = $props();
</script>
        ...
        <div class="flex items-start gap-4">
          ...
          <div class="flex-1">
            ...
            <div class="flex gap-2 flex-wrap">
              <Button onclick={onUpdate} size="sm">Update Now</Button>
              <Button onclick={onDismiss} variant="outline" size="sm">Later</Button>
            </div>
          </div>
          <button
            onclick={onDismiss}
